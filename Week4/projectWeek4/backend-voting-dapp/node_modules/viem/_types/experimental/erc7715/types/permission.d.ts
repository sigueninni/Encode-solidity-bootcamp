...
export type Permission<amount = bigint> = OneOf<NativeTokenLimitPermission<amount> | Erc20LimitPermission<amount> | GasLimitPermission<amount> | ContractCallPermission | RateLimitPermission> & {
